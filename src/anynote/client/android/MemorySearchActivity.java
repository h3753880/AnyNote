	...
	public void onCreate(Bundle savedInstanceState)
	  {
	     ...
	     friendButton.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
	            	...
	            	if(AnyNoteActivity.facebook.isSessionValid()) { 
	            		myDialog = ProgressDialog.show(MemorySearchActivity.this,
	        					"", "loading...", true);
	        			new Thread() {
	        				public void run() {
	        					try {
			            	...
			            	intent.setClass(MemorySearchActivity.this, Friend_list.class);
			            	//startActivity(intent);
			            	startActivityForResult(intent,4);
			            	System.out.println("after");
	            	 }else{
		            		Toast.makeText(MemorySearchActivity.this, "請重新登入後再使用此功能", Toast.LENGTH_LONG).show();
		            	}            	
	            }
	        });
	     cancelButton.setOnClickListener(new View.OnClickListener() {
	            @Override
				public void onClick(View v) {
	            	MemorySearchActivity.this.finish();
	     ...
	     searchButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
            	...
            	intent.setClass(MemorySearchActivity.this,MemoryActivity.class);
		 ...
		 ArrayAdapter<String> adapter = new ArrayAdapter<String>
	        ...
	        upOrDown.setOnItemSelectedListener(new Spinner.OnItemSelectedListener(){
							...
							public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id){
	        	                //Toast.makeText(MemorySearchActivity.this, "您選擇"+adapterView.getSelectedItem().toString(), Toast.LENGTH_LONG).show();
	        	            }
	        	            @Override
							public void onNothingSelected(AdapterView<?> arg0) {
	        	              Toast.makeText(MemorySearchActivity.this, "您沒有選擇任何項目", Toast.LENGTH_LONG).show();
	        	            }
	        });
